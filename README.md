...
That is why GIDS Open Standards has its own [security framework](https://github.com/GIDSOpenStandaarden/GIDSOpenStandaarden-SecurityFramework/blob/main/veiligheidskader.md) in Dutch.
